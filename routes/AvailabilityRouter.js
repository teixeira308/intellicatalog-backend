...
router.put('/availability', login.required, AvaliabilityController.UpdateAvaliability);
router.delete('/availability', login.required, AvaliabilityController.DeleteAvaliability);
